...
System.setProperty("webdriver.chrome.driver","C:\\Users\\srike\\OneDrive\\Pictures\\hurecom bugs\\selenium\\chromedriver-win64\\chromedriver.exe");
	...
	driver.findElement(By.xpath("//input[@type='text']")).sendKeys("sri keerthivasan");
	
	driver.findElement(By.xpath("//input[@formcontrolname='mobileNumber']")).sendKeys("7092621866");

	driver.findElement(By.xpath("( //input[@type='text'])[2]")).sendKeys("tamilvanan@gmail.com");
	...
	driver.findElement(By.xpath("(//input[@type='text'])[6]")).sendKeys("srikeerthivasan");
	 
//	Thread.sleep(3000);
	
	driver.findElement(By.xpath("//input[@type='password']")).sendKeys("sri12345");
